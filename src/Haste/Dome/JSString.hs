...
to, "Haste.DOM.JString". It aims to make a top-down approach to
...
DOM Tree.
-}
module Haste.Dome.JSString where
...
-}
{-# INLINABLE eBuild #-}
eBuild :: MonadIO m => JSString -> Dome m a -> m Elem
...
eAppendChild e = eApply (`appendChild` elemOf e)
...
eAppendBuild :: MonadIO m => JSString -> Dome m a -> Dome m ()
...
-}
{-# INLINABLE eGetStyle #-}
eGetStyle :: MonadIO m => PropID -> Dome m JSString
...
-}
{-# INLINABLE eSetStyle #-}
eSetStyle :: MonadIO m => PropID -> JSString -> Dome m ()
...
-}
{-# INLINABLE eSetClass #-}
eSetClass :: MonadIO m => JSString -> Bool -> Dome m ()
...
eToggleClass :: MonadIO m => JSString -> Dome m ()
...
-}
{-# INLINABLE eHasClass #-}
eHasClass :: MonadIO m => JSString -> Dome m Bool
